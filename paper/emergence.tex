...
with scarce data (24 examples, 30 seeds), the trajectory is: (1) search from scratch, $P$ independent
...
$0.60$; finding one block and tiling it reaches $0.86$ ($+0.25$, ${\sim}15$ SEM of the paired mean). Reuse
beats re-search: the developmental path assembles a structure a flat search cannot afford. Two side
...
escaping bad minima and reuse avoids them. This chains find, clone, and translate; chaining in
recombination of a \emph{second} discovered block, for a two-operation task, is the open step (Limitations).
...
translate; chaining in recombination of a second discovered block, on a genuinely compositional task, and a
real dataset, are the natural next steps; the K=3
